...
**2022-02-07 追記**
**USB HDDについて追試したところ、結果が変わりました。後日改めて記事を更新します。**
...
今回実験に使ったディスク箱はeSATA接続の場合ポートマルチプライヤのサポートが必須となりますが、SATAコントローラがポートマルチプライヤをサポートしているかどうかはFreeBSDの場合起動時のメッセージで確認できます。次の例ではahci0はポートマルチプライヤのサポート有り、ahci1はサポート無しです。
